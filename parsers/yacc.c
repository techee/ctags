...
static  void change_section (const char *line UNUSED,
			     const regexMatch *matches UNUSED,
...
static void enter_c_prologue (const char *line UNUSED,
			      const regexMatch *matches UNUSED,
			      unsigned int count UNUSED,
			      void *data)
{
...
static void leave_c_prologue (const char *line UNUSED,
			      const regexMatch *matches UNUSED,
			      unsigned int count UNUSED,
			      void *data)
{
...
static void enter_union (const char *line UNUSED,
...
static void leave_union (const char *line UNUSED,
			 const regexMatch *matches,
			 unsigned int count UNUSED,
			 void *data)
{
