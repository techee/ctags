...
static const char *renderAsIs (vString* b UNUSED, const char *s)
{
	return s;
}

static const char *renderEscapedString (const char *s,
					const tagEntryInfo *const tag UNUSED,
					vString* b)
{
...
static const char *renderFieldName (const tagEntryInfo *const tag, const char *value UNUSED, vString* b)
{
	return renderEscapedName (tag->name, tag, b);
}

static const char *renderFieldInput (const tagEntryInfo *const tag, const char *value UNUSED, vString* b)
{
...
static const char *renderFieldSignature (const tagEntryInfo *const tag, const char *value UNUSED, vString* b)
{
	return renderEscapedString (WITH_DEFUALT_VALUE (tag->extensionFields.signature),
				    tag, b);
}

static const char *renderFieldScope (const tagEntryInfo *const tag, const char *value UNUSED, vString* b)
{
	const char* scope;
...
static const char *renderFieldInherits (const tagEntryInfo *const tag, const char *value UNUSED, vString* b)
{
	return renderEscapedString (WITH_DEFUALT_VALUE (tag->extensionFields.inheritance),
				    tag, b);
}

static const char *renderFieldTyperef (const tagEntryInfo *const tag, const char *value UNUSED, vString* b)
{
...
static const char *renderFieldKindName (const tagEntryInfo *const tag, const char *value UNUSED, vString* b)
{
