...
static boolean ptagMakeFormat (ptagDesc *desc, void *data UNUSED)
{
	char format [11];
...
static boolean ptagMakeHowSorted (ptagDesc *desc, void *data UNUSED)
{
	return writePseudoTag (desc,
...
static boolean ptagMakeProgVersion (ptagDesc *desc, void *data UNUSED)
{
...
#ifdef HAVE_ICONV
static boolean ptagMakeFileEncoding (ptagDesc *desc, void *data UNUSED)
{
