...
static void processListFeaturesOption(const char *const option UNUSED,
...
static void processListFieldsOption(const char *const option UNUSED,
				    const char *const parameter)
{
...
static void processListExtraOption (
		const char *const option UNUSED, const char *const parameter UNUSED)
{
	printXtags ();
	exit (0);
}
...
static void processListMapsOptionForType (const char *const UNUSED option,
					  const char *const  parameter,
					  langmapType type)
{
	if (parameter [0] == '\0' || strcasecmp (parameter, "all") == 0)
...
static void processListRolesOptions (const char *const option UNUSED,
				     const char *const parameter)
{
	const char* sep;
...
static void processOutputFormat (const char *const option UNUSED,
				 const char *const parameter)
{
	if (parameter [0] == '\0')
...
static void processPseudoTags (const char *const option UNUSED,
			       const char *const parameter)
{
	const char *p = parameter;
	boolean s;
...
static void processForceQuitOption (const char *const option UNUSED,
				    const char *const parameter)
{
	int s;
...
static void processXformatOption (const char *const option UNUSED,
				  const char *const parameter)
{
