...
extern int writeCtagsEntry (MIO * mio, const tagEntryInfo *const tag, void *data UNUSED);
extern int writeXrefEntry  (MIO * mio, const tagEntryInfo *const tag, void *data UNUSED);
extern int writeJsonEntry  (MIO * mio, const tagEntryInfo *const tag, void *data UNUSED);

extern int writeCtagsPtagEntry (MIO * mio, const ptagDesc *desc,
				const char *const fileName,
				const char *const pattern,
				const char *const parserName, void *data UNUSED);
...
extern boolean ptagMakeJsonOutputVersion (ptagDesc *desc, void *data UNUSED);
