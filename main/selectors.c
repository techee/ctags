...
static const char *
tastePerlLine (const char *line, void *data UNUSED)
{
    while (isspace(*line))
        ++line;
...
static const char *
tasteObjectiveCOrMatLabLines (const char *line, void *data UNUSED)
{
    if (startsWith (line, "% ")
	|| startsWith (line, "%{"))
	return TR_MATLAB;
...
static const char *
tasteObjectiveC (const char *line, void *data UNUSED)
{
...
static const char *
tasteR (const char *line, void *data UNUSED)
{
...
static void suppressWarning (void *ctx UNUSED, const char *msg UNUSED, ...)
{
}
